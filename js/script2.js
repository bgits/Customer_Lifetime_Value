...
$(document).ready(function () {
    ...
    function ShowValue2 (selector, v) {
        $(selector).html(isNaN(v) ? "Error" : v + " Years " + "with " + total_customer + " customers. " + "Annual revenue at that time will be: $" + numberWithCommas((revenue * total_customer)) + " with gross margin of $" + numberWithCommas((revenue * margin) * total_customer) + " and annual profit of: $" + numberWithCommas(profit)); 
    }
...
//        nltv();
   ...
   function dcf () {
    ...
    return a + b;
}); window.termv = dcash[cfyear - 1] / discount /*compute terminal value */	
}
